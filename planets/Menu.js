  ...
  return (
    ...
    <div className='w-full h-full flex flex-col justify-center items-center'>
      ...
      {planets.map((planet, index) => 
            ...
            <button key={index} onClick={() => {navigateToPlanet(planet.name); setIsActive(false);}} id={planet.name} className='navbtns text-white relative flex flex-col jusitfy-center items-center border border-transparent rounded-lg hover:border-white'>
        ...
        <div className='w-full text-center col-span-full mt-5'>
          <a target={'_blank'} href={'https://github.com/gnpaone/spaceExplore'} className='inline ml-3 underline'>Github</a>
          
          <button className='block text-center mx-auto mt-1'>Designed and developed by <span className=' underline'>gnpaone</span></button>
        </div>
